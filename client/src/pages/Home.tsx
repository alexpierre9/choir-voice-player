...
import { Music, Upload, Users, Volume2, Search, Trash2 } from "lucide-react";
...
export default function Home() {
  ...
  const {
    ...
    isError: sheetsError,
  } = trpc.sheetMusic.list.useQuery(undefined, {
    enabled: !!user,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Upload sheet music and hear each SATB voice part individually.
            Perfect for choir practice, learning, and arrangement analysis.
          </p>
            ...
            {sheetsLoading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[...Array(skeletonCount)].map((_, i) => (
                  <Card
                    key={i}
                    className="p-4 animate-pulse dark:bg-gray-800 dark:border-gray-700"
                  >
                ...
                {filteredSheets.map((sheet) => (
                  <Card
                    ...
                    className={`p-4 hover:shadow-lg transition-shadow cursor-pointer dark:bg-gray-800 dark:border-gray-700 ${
                      selectedIds.has(sheet.id) ? "ring-2 ring-blue-500" : ""
                    }`}
                    onClick={() => {
                      if (selectMode) {
                        setSelectedIds((prev) => {
              ...
              <Card className="p-12 text-center dark:bg-gray-800 dark:border-gray-700">
                <div className="mx-auto max-w-md">
                  ...
                  <p className="text-gray-600 mb-6 dark:text-gray-300">
                    You haven't uploaded any sheet music yet. Get started by
                    uploading your first score.
                  </p>
                  <Button
                    size="lg"
                    onClick={() => setLocation("/upload")}
              ...
              <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-background border shadow-lg rounded-lg p-3 flex items-center gap-3">
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>
                        Delete {selectedIds.size} sheet(s)?
                      </AlertDialogTitle>
                      <AlertDialogDescription>
                        This will permanently delete the selected sheet music and
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    support both scanned PDFs (using optical music recognition)
                    and digital MusicXML files.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Our system analyzes the sheet music and automatically
                    identifies which parts belong to Soprano, Alto, Tenor, and
                    Bass based on clefs, pitch ranges, and part names.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Check the detected voice assignments. If needed, manually
                    adjust which parts correspond to which voices using the
                    dropdown menus.
                  </p>
                </div>
              </div>
            ...
            <Card className="p-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Use the MIDI player to play each voice individually or
                    together. Control the volume of each part, mute voices, and
                    follow along with your score.
                  </p>
                </div>
              </div>
            </Card>
      ...
      <footer className="border-t bg-white/80 backdrop-blur-sm mt-16">
        <div className="container mx-auto px-6 py-8 text-center text-gray-600">
          <p>
            &copy; {new Date().getFullYear()} {APP_TITLE}. Built for choir
